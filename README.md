...
- Метод отлично работает с симметричными профилями, однако несимметричные вызывают некоторые трудности и при некоторых значениях параметров их удается решить, а при других решение полностью ломается, это связно с особенностями метода.
