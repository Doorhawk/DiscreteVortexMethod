...
public:
    ...
    Wing();
    Wing(int n, double m, double p, double t,double h);
...
private:
    ...
    vector<point> getWingCoord(int n, double m, double p, double t,double h);      // return array of wing points
};